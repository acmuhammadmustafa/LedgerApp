...
In the application you will be displayed with a home menu:<img width="262" height="292" alt="image" src="https://github.com/user-attachments/assets/bcb98590-3268-4e65-a64c-97cdfd03cda9" /> | Here you will want to select an option. 
...
3.) "L) Ledger" displays a new menu:<img width="262" height="235" alt="image" src="https://github.com/user-attachments/assets/2dc9b8fa-4ffd-41c7-bd42-a0d6fa7cda59" />

Ledger Menu:
4.) "A) All" will display ALL transactions. 
5.) "D) Deposits" will display ONLY deposits.
6.) "P) Payments" will display ONLY payments.
7.) "R) Reports" will prompt you with a new menu:<img width="253" height="236" alt="image" src="https://github.com/user-attachments/assets/08f6bf82-986c-4a49-a5cf-342e9da13a51" />
